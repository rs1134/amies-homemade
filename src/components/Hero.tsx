...
const Hero: React.FC<HeroProps> = ({ onShopClick, onAboutClick }) => {
  return (
    <section className="relative overflow-hidden md:min-h-[85vh] md:flex md:items-center md:pt-20">
      ...
      {/* Image — in normal flow on mobile (visible banner), absolute full-bleed on desktop */}
      <div className="relative h-56 mt-20 md:absolute md:inset-0 md:h-auto md:mt-0 z-0">
        <img
      ...
      {/* Content card */}
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-5 md:py-12">
        <div className="max-w-2xl bg-[#FFF8EE]/90 backdrop-blur-xl p-5 sm:p-10 lg:p-16 rounded-[2rem] sm:rounded-[4rem] border border-white/20 shadow-2xl relative animate-in fade-in slide-in-from-left duration-700">
