      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-12">
          ...
          <div className="min-w-0">
            ...
            {/* Delivery reassurance — scoped to the two gift hampers
                specifically, since the biggest hesitation at checkout for a
                gift is "will it arrive in time". Kept accurate to the real
                delivery promise already used elsewhere (Ahmedabad same day,
                pan-India 3-5 days) rather than a blanket "next-day" claim
                that wouldn't hold for customers outside Ahmedabad. */}
            {(product.id === 'g4' || product.id === 'g5') && (
              <div className="flex items-start gap-2.5 mb-5 p-3.5 rounded-2xl bg-[#F6C94C]/10 border border-[#F6C94C]/30">
                ...
                <p className="text-[13px] text-[#4A3728]/80 leading-snug">
                  <span className="font-bold text-[#4A3728]">Order now for the perfect gift.</span> Same-day delivery available in Ahmedabad.
                </p>
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              ...
              <div className="flex items-center gap-1.5 text-[10px] font-bold brand-rounded uppercase text-[#4A3728]/50 col-span-2">
                Also Available on <img src="https://ik.imagekit.io/amieshomemade/Amazon-logo-meaning.jpg" alt="Amazon" className="h-4 w-auto object-contain" />
              </div>
            </div>
