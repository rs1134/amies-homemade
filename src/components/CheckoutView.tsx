        ...
        <div className="space-y-5">
          ...
          <div className="bg-white p-5 sm:p-7 rounded-[2rem] shadow-xl border border-[#F04E4E]/5">
            ...
            <div className={fieldGap}>
              ...
              <div className={`space-y-1.5 ${checkoutStep === 'address' ? '' : 'hidden'} lg:block`}>
                ...
                <div className="relative">
                  <input
                    ...
                    autoComplete="off"
                    className={`w-full ${fieldPad} pl-11 bg-[#F9F5EE] rounded-xl border-2 border-[#4A3728]/10 text-[#4A3728] font-medium placeholder:text-[#4A3728]/40 focus:ring-2 focus:ring-[#F04E4E]/10 focus:border-[#F04E4E] outline-none text-base transition-all disabled:opacity-50`}
                  />
              ...
              <div className={`grid grid-cols-1 sm:grid-cols-2 gap-3 ${checkoutStep === 'details' ? '' : 'hidden'} lg:grid`}>
                {/* Phone */}
