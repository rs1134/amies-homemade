    ...
    if (currentPage === 'faq') {
      injectSchema('faqpage-schema', {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'What is the shelf life of your products?', acceptedAnswer: { '@type': 'Answer', text: 'Mukhwas stays fresh for 3 to 4 weeks in an airtight container. Snacks stay fresh for 2 to 3 weeks. Sweets are best consumed within 10 to 14 days. No preservatives means a shorter but more genuine shelf life.' } },
