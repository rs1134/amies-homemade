    ...
    if (currentPage === 'faq') {
      injectSchema('faqpage-schema', {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'What is the shelf life of your products?', acceptedAnswer: { '@type': 'Answer', text: 'Mukhwas stays fresh for 3 to 4 months in an airtight container. Snacks stay fresh for up to 60 days. Sweets are best consumed within 30 days.' } },
